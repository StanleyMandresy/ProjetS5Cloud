...
TRUNCATE TABLE historique_etapes, point_de_reparation, entreprise, utilisateur CASCADE;
...
ALTER SEQUENCE point_de_reparation_id_point_seq RESTART WITH 1;
ALTER SEQUENCE historique_etapes_id_historique_seq RESTART WITH 1;
...
('Jean Dupont', 'jean.dupont@example.com', '$2a$10$hashedpassword1', 'MANAGER'),
('Marie Martin', 'marie.martin@example.com', '$2a$10$hashedpassword2', 'USER'),
('Pierre Durand', 'pierre.durand@example.com', '$2a$10$hashedpassword3', 'USER');
